...
import img3 from '../images/_DSC0721.jpg.jpeg';
import img4 from '../images/IMG_20241203_100535.jpg.jpeg';
import img5 from '../images/IMG_20250410_164834(1).jpg.jpeg';
    ...
    <div ref={triggerRef} className="bg-[#020202] select-none">
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="relative w-[92vw] max-w-[1200px] aspect-[19.5/9] z-10">
          ...
          <div className="absolute inset-[2.4%] w-[92%] ml-4 overflow-hidden rounded-[5rem] bg-black">
            ...
            <div className="absolute inset-0 z-30 flex flex-col justify-between">
              ...
              <div className="w-full bg-linear-to-t from-black via-black/80 to-transparent pt-28 pb-6 px-12">
