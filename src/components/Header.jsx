  ...
  return (
    <header className="w-full fixed top-4 left-0 z-50">
      <div className="max-w-md mx-auto px-4">
        <div className="backdrop-blur-xl bg-black/55 border border-white/10 rounded-full px-7 py-5 flex items-center justify-between shadow-lg hover:scale-105 transition-transform duration-500">
